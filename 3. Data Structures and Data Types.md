...
#### <span style="color:red">Linked Lists
...
## ~Abstract Data Types Overview (ADTs)~
...
## Abstract Data Types (ADTs) in detail
#### <span style="color:blue"> Sequences
...
#### <span style="color:blue"> Priority Queue
...
Set operations like intersection are easy to implement by going through two lookup tables and
 applying Boolean operations.

 An efficient implementation of a set is very useful: contrary to lists, stacks and queues, it
 supports the add, remove and membership operations in constant time, 